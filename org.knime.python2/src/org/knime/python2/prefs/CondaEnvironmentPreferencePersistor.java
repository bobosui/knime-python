 ...
 */
final class CondaEnvironmentPreferencePersistor extends AbstractPreferencePersistor<CondaEnvironmentConfig> {

    /**
     * @param config The configuration to save or load.
     */
    public CondaEnvironmentPreferencePersistor(final CondaEnvironmentConfig config) {
        super(config);
    }
    ...
    public void saveSettingsTo(final PreferenceStorage storage) {
        ...
        AbstractPreferencePersistor.saveSettingsEntryTo(m_config.getEnvironmentName(), storage);
    ...
    public void loadSettingsFrom(final PreferenceStorage storage) {
        ...
        AbstractPreferencePersistor.loadSettingsEntryFrom(m_config.getEnvironmentName(), storage);
