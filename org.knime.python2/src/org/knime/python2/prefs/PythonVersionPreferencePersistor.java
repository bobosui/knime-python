 ...
 */
final class PythonVersionPreferencePersistor extends AbstractPreferencePersistor<PythonVersionConfig> {

    /**
     * @param config The configuration to save or load.
     */
    public PythonVersionPreferencePersistor(final PythonVersionConfig config) {
        super(config);
    }

    @Override
    public void saveSettingsTo(final PreferenceStorage storage) {
        AbstractPreferencePersistor.saveSettingsEntryTo(m_config.getPythonVersion(), storage);
    }

    @Override
    public void loadSettingsFrom(final PreferenceStorage storage) {
        AbstractPreferencePersistor.loadSettingsEntryFrom(m_config.getPythonVersion(), storage);
    }
}
