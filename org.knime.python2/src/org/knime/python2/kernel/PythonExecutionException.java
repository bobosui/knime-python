...
public final class PythonExecutionException extends ExecutionException implements PythonException {
    ...
    /**
     * @param message the message
     * @param pythonTraceback The trace back of the error on Python side. Basically corresponds to the {@code cause} argument
     *            in {@link #PythonExecutionException(String, Throwable)} but for a cause on Python side.
     */
